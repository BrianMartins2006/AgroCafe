      ...
      <div className="bg-[#f0f2f5] min-h-full">
        ...
        <div className="bg-white p-8 flex flex-col items-center border-b border-gray-100 shadow-sm">
          <div className="relative group">
            ...
            <button className="absolute bottom-1 right-1 w-12 h-12 bg-whatsapp-teal text-white rounded-full flex items-center justify-center shadow-lg active:scale-90 transition-all border-4 border-white">
              <Camera size={20} />
            </button>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {success && (
              <div className="text-center animate-in fade-in slide-in-from-top-2 duration-300">
                <p className="text-whatsapp-green font-bold text-sm">Seu perfil foi atualizado com sucesso!</p>
              </div>
            )}
          </form>
        </div>
